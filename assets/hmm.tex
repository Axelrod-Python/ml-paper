...
\begin{tikzpicture}[scale=.9]
    ...
    \node (state_output_1) at ($(d_output) + (.55, 0)$) {1};
    \node (p0) at ($(pd) + (.55, 0)$) {\(p_1\)};
    \node (state_output_2) at ($(state_output_1) + (.55, 0)$) {2};
    \node (p1) at ($(p0) + (.55, 0)$) {\(p_2\)};
    \node (state_output_3) at ($(state_output_2) + (.55, 0)$) {3};
    \node (p2) at ($(p1) + (.55, 0)$) {\(p_3\)};
    \node (state_output_4) at ($(state_output_3) + (.55, 0)$) {4};
    \node (p3) at ($(p2) + (.55, 0)$) {\(p_4\)};
