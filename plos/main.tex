...
\begin{landscape}
    \begin{figure}[!hbtp]
        \centering
        \includegraphics[width=.8\paperwidth]{standard_scores_boxplots.pdf}
...
\begin{landscape}
    \begin{figure}[!hbtp]
        \centering
        \includegraphics[width=.8\paperwidth]{standard_wins_boxplots.pdf}
...
\begin{landscape}
    \begin{figure}[!hbtp]
        \centering
        \includegraphics[width=.8\paperwidth]{standard_ranks_boxplots.pdf}
...
\begin{landscape}
    \begin{figure}[!hbtp]
        \centering
        \includegraphics[width=.8\paperwidth]{noisy_scores_boxplots.pdf}
...
\begin{figure}[!hbtp]
    \centering
    \includegraphics[width=.8\textwidth]{noisy_scores_heatmap.pdf}
...
\begin{landscape}
    \begin{figure}[!hbtp]
        \centering
        \includegraphics[width=.8\paperwidth]{noisy_wins_boxplots.pdf}
...
\begin{landscape}
    \begin{figure}[!hbtp]
        \centering
        \includegraphics[width=.8\paperwidth]{noisy_ranks_boxplots.pdf}
...
\newblock {Changes in Prisoner ' s Dilemma Strategies Over Evolutionary Time
  With Different Population Sizes}. 2006; p. 1001--1008.
