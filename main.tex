...
In this manuscript we use the Axelrod library \cite{axelrodproject, knight2016open},
...
with $n_1 = m_1 = m_2 = 2$ that is \emph{mostly deterministic}, with 12 of the 64
