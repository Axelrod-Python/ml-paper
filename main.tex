...
\begin{figure}[!hbtp]
    ...
    column players (ordered by median over
        \protect\input{./assets/standard_number_of_repetitions.tex}tournaments)}
...
\begin{landscape}
    \begin{figure}[!hbtp]
        ...
        \caption{Standard Tournament: number of wins per tournament (ordered by
        median over
        \protect\input{./assets/standard_number_of_repetitions.tex}tournaments)}
...
\begin{landscape}
    \begin{figure}[!hbtp]
        ...
        \caption{Standard Tournament: rank in each tournament (ordered by
        median over
        \protect\input{./assets/standard_number_of_repetitions.tex}tournaments)}
...
\begin{landscape}
    \begin{figure}[!hbtp]
        ...
        \caption{Noisy (5\%) Tournament: number of wins per tournament (ordered by
        median over
        \protect\input{./assets/noisy_number_of_repetitions.tex}tournaments)}
...
\begin{landscape}
    \begin{figure}[!hbtp]
        ...
        \caption{Noisy (5\%) Tournament: rank in each tournament (ordered by
        median over
        \protect\input{./assets/noisy_number_of_repetitions.tex}tournaments)}
